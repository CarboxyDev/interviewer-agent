...
- V2-004 raw-latency analysis is implemented with 33 focused checks and a real V1 tracker-format
  compatibility check. It separates phases/operations, excludes ambiguous partial playback, rejects
